...
**Usage Instructions:**
1. To use them, just download the file and place it in `~/.local/bin` folder.
2. Then make it executable, by doing: `chmod +x ~/.local/bin/name_of_script_file`.
...
Currently this only includes the babls script.
